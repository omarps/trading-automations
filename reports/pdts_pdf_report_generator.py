...
class PdtsPDFReportGenerator(ReportGenerator):
    """
        A class to generate PDTS PDF reports, inheriting from ReportGenerator.
    ...
    def __init__(self, base_path, date, ticker='PDTS'):
        """
        ...
        self.strategies = [
            GeneratePDFMdStrategy(self.suffix),
            # GeneratePDFGraphsStrategy(),
            GeneratePDFGenericStrategy(SCREENSHOTS, suffix=self.suffix),
            GeneratePDFGenericStrategy(OTHERS, suffix=self.suffix)
        ]
